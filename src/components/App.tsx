          ...
          <Fragment>
            ...
            */}
            ...
            <div style={{height: isSmartphone() ? '10em' : '5em'}}>
              ...
              alt="" />
              <p style={{position:'relative', marginTop:'-1.3em', marginLeft:isSmartphone() ? '2.4em' : '2.7em', fontSize:isSmartphone() ? '4em' : "2em", fontFamily:'DINCondensed-Bold'}}>Contact {dispUserName} For Parts</p>
            </div> :
            <div style={{height: isSmartphone() ? '10em' : '5em'}}>
              ...
              alt="" />
              <p style={{position:'relative', marginTop:isSmartphone() ? '-0.9em' : '-1em', marginLeft:isSmartphone() ? '0.5em' : '1em', fontSize:isSmartphone() ? '5em' : '2.5em', fontFamily:'DINCondensed-Bold'}}>{Object(selectedItem)['Doc Ref']}</p>

              <div style={{position:'absolute', width:isSmartphone() ? '5em' : '5em', userSelect:'none', right:'1.8em', top:'0em', opacity:'1', color:'#000000', fontFamily:'DINCondensed-Bold', fontSize:isSmartphone() ? '2em' : '1em'}}>
                <p style={{position:'relative', textAlign:'right', top:'0.3em'}}>DWg #</p>
                <p style={{position:'relative', top:'-0.9em', fontSize:'1.3em', textAlign:'right'}}>{getPageRef(Object(selectedItem)['DD Ref'])}</p>
              </div>

            </div>
            }
            {menuName !== 'docview' && menuName !== 'docdetailview' ?
              <div style={{position:'relative', width:'100%', height:isSmartphone() ? '5em' : '2.5em', backgroundColor:'#000000', top:isSmartphone() ? '-1em' : '0em'}}>
              ...
              <div style={{position:'relative', width:'100%', height:isSmartphone() ? '5em' : '2.5em', backgroundColor:'#000000', top:isSmartphone() ? '-1em' : '0em'}}>
                ...
                <div style={{position:'absolute', width:isSmartphone() ? '100%' : '100%', userSelect:'none', right:'1.5em', top:'0.4em', opacity:'1', color:'#FFBF41', fontFamily:'DINRegular', textAlign:'right', fontSize:isSmartphone() ? '2.3em' : '1.2em'}}>{Object(selectedItem)['Component']}</div>
              </div>
            }
            </div>
            : '' }
